          ...
          <tbody className='text-sm'>
            {rooms.map((room, index) => (
              <tr key={index}>
                ...
                <td class="py-3 px-4 border-t border-gray-300 text-sm text-red-500 text-center">
                  <label class="relative inline-flex items-center cursor-pointer gap-3 text-gray-900">
                    <input type="checkbox" class="sr-only peer" />
                    <div class="w-12 h-7 bg-slate-300 rounded-full peer-checked:bg-blue-600 transition-colors duration-200"></div>
